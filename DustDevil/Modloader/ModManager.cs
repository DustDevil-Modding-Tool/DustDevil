...
using DustDevil.Modloader.AssetLoading;
using UnityEngine;

namespace DustDevil.Modloader {
    public class ModManager {

        public List<DustDevilMod> loadedMods;
        private Dictionary<string, DustDevilMod> loadedModsDictionary;
        private Dictionary<string, string> loadedModsInfo;

        public void Init() {

            loadedMods = new List<DustDevilMod>();
            loadedModsDictionary = new Dictionary<string, DustDevilMod>();
        ...
        public void LoadAllMods() {
            ...
            string modsPath = Path.Combine(DustDevilManager.mainPath, "Mods" ) + '/';
            ...
            Type modType = typeof( DustDevilMod );
            ...
            foreach( Type t in modTypes ) {
                try {
                    DustDevilMod newMod = (DustDevilMod)Activator.CreateInstance( t );
            ...
            foreach( DustDevilMod pMod in loadedMods ) {
        ...
        public void DisableMod(DustDevilMod mod) {
            mod.DisableMod();
        }
        ...
        public void EnableMod(DustDevilMod mod) {
            mod.EnableMod();
        }
